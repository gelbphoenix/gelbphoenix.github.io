            ...
            <section class="container-bottom" id="about_me">
                ...
                <div class="content-bar">
                    <div class="content-box">
                        <h4>Politik:</h4>
                        <span id="button-pol" class="box-botton">Infos:</span>
                        <div id="politic-infos" style="display: none; flex-direction: column;">
                            <p>
                    ...
                    <div class="content-box">
                        <h4>Coding:</h4>
                        <span id="button-cod" class="box-botton">Infos:</span>
                        <div id="code-infos" class="code-style" style="display: none; flex-direction: column;">
                            <p>
                    ...
                    <div class="content-box">
                        <h4>Generell:</h4>
                        <span id="button-gen" class="box-botton">Infos:</span>
                        <div id="general-infos" style="display: none; padding-left: 5px; padding-right: 5px;">
                            <p>
